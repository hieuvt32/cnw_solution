...
<html lang="en">
	<head>
		...
		<title>Shop | Lucent-Shopper</title>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<a href="cart.html"><img src="images/cart/cart-icon.png" width= 30px height=15px alt="" /></a>
								<div class="btn btn-default">
								<span>You have 3 product</span>
								</div>
	            			</div>	
            			</div>
						...
						<div class="col-sm-9">
							...
							<div class="mainmenu pull-left">
								<ul class="nav navbar-nav collapse navbar-collapse">
									...
									<li><a href="admin.html">Blog</a>    </li>
						...
						<div id="slider-carousel" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="item active">
									<div class="col-sm-6">
										<h1><span>Lucent</span>-SHOPPER</h1>
